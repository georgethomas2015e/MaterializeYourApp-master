...
/**
 * Created by kishan on 5/12/2016.
 */
class horizontalscrollview_adapter extends RecyclerView.Adapter<horizontalscrollview_adapter.ItemHolder>{
    ...
    public horizontalscrollview_adapter(Context context, MainActivity mainActivity){
    ...
    @Override
    public horizontalscrollview_adapter.ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CardView itemCardView = (CardView)layoutInflater.inflate(R.layout.layout_cardview, parent, false);
        return new ItemHolder(itemCardView, this);
    }

    @Override
    public void onBindViewHolder(horizontalscrollview_adapter.ItemHolder holder, int position) {
    ...
    public static class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private horizontalscrollview_adapter parent;
        private CardView cardView;
        ImageView imageView;
        String itemUri;

        public ItemHolder(CardView cardView, horizontalscrollview_adapter parent) {
            super(cardView);
        ...
        public void setImageView(Bitmap bitmap){imageView.setImageBitmap(bitmap);
        }
